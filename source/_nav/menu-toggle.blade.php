<button class="flex justify-center items-center bg-red-500 border border-blue-500 h-10 mr-4 px-5 rounded-full lg:hidden focus:outline-none" onclick="navMenu.toggle()">
